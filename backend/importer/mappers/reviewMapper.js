...
function mapReview(row) {
    ...
    return {
        ...
        subReviewerPersonId: parseIntOrNull(extractValue(row.getCell(13 + offset))),
        subReviewerFirstName: extractValue(row.getCell(10 + offset)) || null,
        subReviewerLastName: extractValue(row.getCell(11 + offset)) || null,
        subReviewerEmail: extractValue(row.getCell(12 + offset)) || null,
